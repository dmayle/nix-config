...
let
  ...
  set4k = pkgs.writeShellScriptBin "set4k" ''
    case "$XDG_CURRENT_DESKTOP" in
      Hyprland)
        bash -c 'sleep 0.5 && hyprctl keyword monitor "desc:Technical Concepts Ltd 65R648,3840x2160@119.88Hz,0x0,1"' &
        ;;
      sway)
  ...
  set5k = pkgs.writeShellScriptBin "set5k" ''
    case "$XDG_CURRENT_DESKTOP" in
      Hyprland)
        bash -c 'sleep 0.5 && hyprctl keyword monitor "desc:Technical Concepts Ltd 65R648,7680x4320@59.940Hz,1.5x1.5"' &
        ;;
      sway)
  ...
  set8k = pkgs.writeShellScriptBin "set8k" ''
    case "$XDG_CURRENT_DESKTOP" in
      Hyprland)
        bash -c 'sleep 0.5 && hyprctl keyword monitor "desc:Technical Concepts Ltd 65R648,7680x4320@59.940Hz,0x0,1"' &
        ;;
      sway)
